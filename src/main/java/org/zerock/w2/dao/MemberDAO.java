...
public class MemberDAO {
    public MemberVO getWithPassword(String mid, String mpw) throws Exception {
        ...
        memberVO = MemberVO.builder().mid(resultSet.getString(1)).mpw(resultSet.getString(2))
    ...
    public MemberVO selectUUID(String uuid) throws Exception{
        ...
        MemberVO memberVO = MemberVO.builder().mid(resultSet.getString(1))
                .mpw(resultSet.getString(2)).mname(resultSet.getString(3))
                .uuid(resultSet.getString(4)).build();
